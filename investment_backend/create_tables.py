...
def create_tables(db_name):
    ...
    if db_name == INVESTMENTS_DB:
        ...
        VALUES
            ...
            ('type_risk_multiplier', '1.3', 'Risk score multiplier for investment-type-segregated views', 'simulation', true),
            ('institution_risk_multiplier', '1.4', 'Risk score multiplier for institution-segregated views', 'simulation', true),
            ('portfolio_dividend_baseline', '0.04', 'Baseline dividend yield (fraction) used for portfolio-wide estimates', 'simulation', true),
            ('individual_dividend_base', '0.04', 'Baseline dividend yield (fraction) used for individual investment estimates', 'simulation', true),
            ('correction_probability_portfolio', '0.02', 'Probability of a market correction event in portfolio simulation (fraction)', 'simulation', true),
            ('correction_probability_individual', '0.04', 'Probability of a market correction event in individual investment simulation (fraction)', 'simulation', true),
            ('market_correction_min', '0.05', 'Minimum magnitude of a simulated market correction (fraction)', 'simulation', true),
            ('market_correction_max', '0.15', 'Maximum magnitude of a simulated market correction (fraction)', 'simulation', true),
            ('volatility_baseline_portfolio', '0.15', 'Default annualised volatility for portfolio-level Monte Carlo when history is absent', 'simulation', true),
            ('volatility_baseline_1y', '0.15', 'Default annualised volatility for 1-year rolling simulation', 'simulation', true),
            ('volatility_baseline_3y', '0.20', 'Default annualised volatility for 3-year rolling simulation', 'simulation', true),
            ('volatility_baseline_5y', '0.25', 'Default annualised volatility for 5-year rolling simulation', 'simulation', true),
            ('std_dev_monthly', '0.03', 'Default monthly standard deviation used in risk calculations', 'simulation', true),
            ('cagr_excellent_threshold', '0.15', 'CAGR threshold above which performance is rated Excellent (fraction)', 'performance', true),
            ('cagr_good_threshold', '0.08', 'CAGR threshold above which performance is rated Good (fraction)', 'performance', true),
            ('excellent_sharpe_ratio', '1.2', 'Sharpe ratio threshold for Excellent rating', 'performance', true),
            ('good_sharpe_ratio', '0.8', 'Sharpe ratio threshold for Good rating', 'performance', true),
            ('excellent_return_threshold', '50.0', 'Total return % threshold for Excellent rating', 'performance', true),
            ('good_return_threshold', '20.0', 'Total return % threshold for Good rating', 'performance', true),
            ('good_volatility_threshold', '0.15', 'Annualised volatility below which is considered Good (fraction)', 'performance', true),
            ('property_growth_std', '2.5', 'Standard deviation for property growth rate in Monte Carlo (percentage points)', 'property', true),
            ('rental_growth_std', '2.0', 'Standard deviation for rental growth rate in Monte Carlo (percentage points)', 'property', true),
            ('interest_rate_std', '1.5', 'Standard deviation for bond interest rate in Monte Carlo (percentage points)', 'property', true),
            ('monte_carlo_fallback_value', '100000', 'Initial portfolio value used as fallback in Monte Carlo when DB has no data', 'simulation', true),
            ('monte_carlo_fallback_contribution', '5000', 'Monthly contribution used as fallback in Monte Carlo when DB has no data', 'simulation', true),
            ('monte_carlo_fallback_mu', '0.10', 'Expected annual return used as fallback in Monte Carlo when DB has no data (fraction)', 'simulation', true),
            ('dashboard_default_value', '100000', 'Default value shown on dashboard when no real data is available', 'display', true),
            ('fallback_contribution_divisor', '1.27', 'Divisor used to derive an implied monthly contribution from contribution history', 'simulation', true),
            ('fallback_investment_time_years', '1.5', 'Assumed holding period (years) used when estimating IRR from limited history', 'simulation', true),
            ('fallback_portfolio_irr', '9.5', 'Default portfolio IRR (percent) used when no return history is available', 'simulation', true),
            ('daily_growth_baseline', '0.001', 'Baseline daily growth rate (fraction) used in projection fallbacks', 'simulation', true),
            ('drawdown_data_points', '200', 'Number of data points sampled for drawdown analysis', 'performance', true),
            ('performance_data_points', '48', 'Number of data points sampled for performance charts', 'performance', true),
            ('rolling_1y_periods', '12', 'Number of monthly periods used for the 1-year rolling return window', 'performance', true),
            ('rolling_3y_periods', '20', 'Number of monthly periods used for the 3-year rolling return window', 'performance', true),
            ('rolling_5y_periods', '10', 'Number of monthly periods used for the 5-year rolling return window', 'performance', true),
            ('volatility_periods', '24', 'Number of monthly periods used for annualised volatility calculation', 'performance', true),
            ('sharpe_periods', '16', 'Number of monthly periods used for the Sharpe ratio calculation', 'performance', true),
